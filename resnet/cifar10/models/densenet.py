# Copied from https://github.com/gpleiss/efficient_densenet_pytorch/blob/master/models/densenet_efficient.py
...
def DenseNetBC(L, k, num_classes=10):
    ...
    return DenseNetEfficient(growth_rate=k, block_config=[num_blocks] * 3,
                             compression=0.5, num_init_features=2*k,
